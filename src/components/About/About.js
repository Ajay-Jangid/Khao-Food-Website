...
const About = () => {
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <section className="mb-8">
                <h2 className="text-2xl lg:text-3xl xl:text-4xl font-bold mb-2">How It Works</h2>
                <ol className="list-decimal pl-6 text-lg lg:text-xl xl:text-2xl text-gray-700 mb-4">
            ...
            <section className="mb-8">
                <h2 className="text-2xl lg:text-3xl xl:text-4xl font-bold mb-2">Why Choose Us</h2>
                <ul className="list-disc pl-6 text-lg lg:text-xl xl:text-2xl text-gray-700 mb-4">
            ...
            <section className="mb-8">
                <h2 className="text-2xl lg:text-3xl xl:text-4xl font-bold mb-2">Contact Us</h2>
                <p className="text-lg lg:text-xl xl:text-2xl text-gray-700 mb-4">
            ...
            <section>
                <h2 className="text-2xl lg:text-3xl xl:text-4xl font-bold mb-2">Start Ordering Now!</h2>
